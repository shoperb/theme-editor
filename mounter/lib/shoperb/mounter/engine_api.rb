...
module Shoperb
  module Mounter
    ...
    class EngineApi
      ...
      def self.teardown
        Shoperb::Mounter::EngineApi.default_options[:base_uri] = nil
        Shoperb::Mounter::EngineApi.default_options[:base_auth] = nil
        Shoperb::Mounter::EngineApi.default_options[:default_params] = {}
      end
