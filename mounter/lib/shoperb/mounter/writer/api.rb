    ...
    module Writer
      module Api
        ...
        class Runner < Shoperb::Mounter::Writer::Runner
          ...
          # Call the ShoperbCMS engine to get a token for
          # the next API calls
          def prepare
            ...
            begin
              Shoperb::Mounter::EngineApi.set_token(credentials)
            rescue Exception => e
              raise Shoperb::Mounter::WriterException.new("unable to get an API token: #{e.message}")
            end
          end
