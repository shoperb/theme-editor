  ...
  module Mounter
    module Writer
      module Api
        ...
        # Push pages to a remote ShoperbCMS engine.
        #
        ...
        class PagesWriter < Base
          ...
          #     #   !page.translated_in?(Shoperb::Mounter.locale)
          #     if !self.safely_translated?(page)
          #       self.output_resource_op page
          #       self.output_resource_op_status page, :not_translated
          #       true
          ...
          def safely_translated?(page)
            if page.parent.nil?
              ...
              page.parent.translated_in?(Shoperb::Mounter.locale) &&
              page.translated_in?(Shoperb::Mounter.locale)
            end
          end
