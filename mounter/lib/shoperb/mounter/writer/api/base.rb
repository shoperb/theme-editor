      ...
      module Api
        ...
        class Base
          ...
          def get(resource_name, locale = nil, raw = false)
            ...
            response  = Shoperb::Mounter::EngineApi.get("/#{resource_name}.json", params)
          ...
          def post(resource_name, params, locale = nil, raw = false)
            ...
            response  = Shoperb::Mounter::EngineApi.post("/#{resource_name}.json", query)
            data      = response.parsed_response
          ...
          def put(resource_name, id, params, locale = nil)
            ...
            response  = Shoperb::Mounter::EngineApi.put("/#{resource_name}/#{id}.json", query)
            data      = response.parsed_response
