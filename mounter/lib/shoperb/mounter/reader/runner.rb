  ...
  module Mounter
    module Reader
      ...
      class Runner
        ...
        #
        def reload(*list)
          Shoperb::Mounter.with_locale(self.mounting_point.default_locale) do
        ...
        #
        def readers
          raise Shoperb::Mounter::ImplementationIsMissingException.new('readers are missing')
        end

        protected

        def build_mounting_point
          Shoperb::Mounter::MountingPoint.new.tap do |mounting_point|
