  ...
  module Mounter
    ...
    class MountingPoint
      ...
      def path= dir
        ...
        @sprockets = Shoperb::Mounter::Extensions::Sprockets.environment @path
        %w(fonts stylesheets javascripts).each do |name|
          @sprockets.append_path File.join(dir, name)
        end
      end
      ...
      #
      def default_locale
        (self.locales.first || Shoperb::Mounter.locale).to_sym
      end
