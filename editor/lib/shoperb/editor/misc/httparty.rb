    ...
    module Httparty
      class Webservice
        ...
        def self.consume(url, options = {})
          ...
          # Shoperb::Editor::Logger.debug "[WebService] consuming #{path}, #{options.inspect}"
          ...
          if response.code == 200
            ...
            Shoperb::Editor::Logger.error "[WebService] consumed #{path}, #{options.inspect}, response = #{response.inspect}"
            nil
          end
