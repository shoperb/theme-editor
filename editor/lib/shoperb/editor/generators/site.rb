    ...
    module Generators
      ...
      module Site
        ...
        def self.register(name, klass, description = nil)
          Shoperb::Editor::Generators::Site::List.instance.register(name, klass, description)
        end
        ...
        #
        def self.get(name)
          Shoperb::Editor::Generators::Site::List.instance.get(name)
        end
        ...
        #
        def self.list
          Shoperb::Editor::Generators::Site::List.instance._list
        end
        ...
        def self.list_to_json
          Shoperb::Editor::Generators::Site::List.instance.to_json
        end
        ...
        #
        def self.empty?
          Shoperb::Editor::Generators::Site::List.instance._list.empty?
        end
...
require 'shoperb/editor/generators/site/base'
require 'shoperb/editor/generators/site/blank'
require 'shoperb/editor/generators/site/bootstrap2'
require 'shoperb/editor/generators/site/bootstrap3'
require 'shoperb/editor/generators/site/foundation'
require 'shoperb/editor/generators/site/unzip'
require 'shoperb/editor/generators/site/cloned'
